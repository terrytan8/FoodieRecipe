...
import com.example.foodierecipe.databinding.ActivityAddUpdateRecipeBinding
import com.example.foodierecipe.databinding.DialogCustomImageSelectionBinding
...
class AddUpdateRecipeActivity : AppCompatActivity(), View.OnClickListener {
                ...
                R.id.btn_add_dish->{
                    ...
                    when{
                        ...
                        TextUtils.isEmpty(mImagePath)->{
                            Toast.makeText(this@AddUpdateRecipeActivity,resources.getString(R.string.err_msg_select_dish_image),
                        ...
                        TextUtils.isEmpty(cookingDirection)->{
                            ...
                            mRecipeDetails?.let {
                                if(it.id!=0){
                                    ...
                                    favouriteDish = it.favouriteRecipe
                                }
                            }
                            val favDishDetails:Recipe = Recipe(
                                mImagePath,
                                imageSource,
                                title,
                                type,
    ...
    private fun customItemDialog(title:String,itemList:List<String>,selection:String){
        ...
        val adapter= CustomListAdapter(this,null,itemList,selection)
    ...
    companion object{
        ...
        private const val IMAGE_DIRECTORY = "RecipeImages" //The photo directory
    }
}